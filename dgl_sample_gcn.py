...
class overAll(nn.Module):
    ...
    def forward(self, blocks, g_r):
        ...
        # equals to
        self.graph.ndata['f'] = self.ent_emb,




        self.graph.ndata['temp_feat'] = self.ent_emb
        ent_feature = blocks[0].srcdata['temp_feat']
